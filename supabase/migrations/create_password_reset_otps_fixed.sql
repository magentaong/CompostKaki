-- Create password_reset_otps table (new structure with multiple OTPs support)
-- Use this if the table doesn't exist at all
-- This creates the table with the correct structure from the start
